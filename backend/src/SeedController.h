...
public:
    METHOD_LIST_BEGIN
        ADD_METHOD_TO(SeedController::seedWeather,   "/api/weather/seed",      drogon::Post, drogon::Options);
        ADD_METHOD_TO(SeedController::getLocations,  "/api/weather/locations", drogon::Get,  drogon::Options);
        ADD_METHOD_TO(SeedController::setSpeed,      "/api/weather/speed",     drogon::Post, drogon::Options);
    METHOD_LIST_END

    // POST /api/weather/seed  body: {"lat":44.4,"lon":26.1}
    ...
    // POST /api/weather/speed  body: {"value":5}
